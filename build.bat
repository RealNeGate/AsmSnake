...
start /b /wait "" "cl" build/first.obj /link /nologo /machine:x64 /subsystem:windows /debug:none /entry:entry /out:%output_file_name%.exe kernel32.lib user32.lib Gdi32.lib
